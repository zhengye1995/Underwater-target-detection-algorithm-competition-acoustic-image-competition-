...
class CascadeRCNN(BaseDetector, RPNTestMixin):
    ...
    def forward_train(self,
        ...
        # TODO no gt
        # if 's0.loss_bbox' not in losses:
        #     losses['s0.loss_bbox'] = losses['loss_rpn_bbox'][0].clone()
        #     losses['s1.loss_bbox'] = losses['loss_rpn_bbox'][0].clone()
        #     losses['s2.loss_bbox'] = losses['loss_rpn_bbox'][0].clone()
        return losses
